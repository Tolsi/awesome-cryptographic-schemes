...
Alphabetical index of all 1247 scheme entries.
...
- [Architecture-Private ZK Proof of Neural Networks](categories/04-zero-knowledge-proof-systems.md#architecture-private-zk-proof-of-neural-networks)
...
- [Blinding Post-Quantum Hash-and-Sign Signatures](categories/08-signatures-advanced.md#blinding-post-quantum-hash-and-sign-signatures)
...
- [Compact Post-Quantum Strong Designated Verifier from Isogenies](categories/08-signatures-advanced.md#compact-post-quantum-strong-designated-verifier-from-isogenies)
...
- [Faster Than Ever PSI (New Lightweight Paradigm)](categories/10-privacy-preserving-computation.md#faster-than-ever-psi-new-lightweight-paradigm)
...
- [Finally! A Compact Lattice-Based Threshold Signature](categories/08-signatures-advanced.md#finally-a-compact-lattice-based-threshold-signature)
...
- [Fuzzy Private Set Intersection from VOLE](categories/10-privacy-preserving-computation.md#fuzzy-private-set-intersection-from-vole)
...
- [HOBBIT (Space-Efficient zkSNARK with Optimal Prover Time)](categories/04-zero-knowledge-proof-systems.md#hobbit-space-efficient-zksnark-with-optimal-prover-time)
...
- [InsPIRe (Silent-Preprocessing PIR — IEEE S&P 2026)](categories/10-privacy-preserving-computation.md#inspire-silent-preprocessing-pir-ieee-sp-2026)
...
- [JAGUAR (Malicious Unbalanced PSI in Client-Server)](categories/10-privacy-preserving-computation.md#jaguar-malicious-unbalanced-psi-in-client-server)
...
- [Lattice Group Signatures, Revisited](categories/08-signatures-advanced.md#lattice-group-signatures-revisited)
...
- [Mangrove (Distributed SNARK via Folding Schemes)](categories/04-zero-knowledge-proof-systems.md#mangrove-distributed-snark-via-folding-schemes)
...
- [Migration to Post-Quantum Cryptography: From ECDSA to ML-DSA](categories/08-signatures-advanced.md#migration-to-post-quantum-cryptography-from-ecdsa-to-ml-dsa)
...
- [Plonk Without Random Oracles](categories/04-zero-knowledge-proof-systems.md#plonk-without-random-oracles)
...
- [Post-Quantum k-Times Traceable Ring Signature (kTRS+)](categories/08-signatures-advanced.md#post-quantum-k-times-traceable-ring-signature-ktrs)
...
- [Proof-Carrying Data via Holography Accumulation](categories/04-zero-knowledge-proof-systems.md#proof-carrying-data-via-holography-accumulation)
...
- [Simple and Efficient Lattice Threshold Signatures with Identifiable Aborts](categories/08-signatures-advanced.md#simple-and-efficient-lattice-threshold-signatures-with-identifiable-aborts)
...
- [SoK: Anonymous Credentials for Digital Identity Wallets (EUDI)](categories/11-anonymity-credentials.md#sok-anonymous-credentials-for-digital-identity-wallets-eudi)
...
- [Symphony (Scalable SNARKs from Lattice-Based High-Arity Folding)](categories/04-zero-knowledge-proof-systems.md#symphony-scalable-snarks-from-lattice-based-high-arity-folding)
...
- [Zero-Knowledge AI Inference with High Precision (IEEE 754)](categories/04-zero-knowledge-proof-systems.md#zero-knowledge-ai-inference-with-high-precision-ieee-754)
...
- [zkGPT (Non-Interactive ZK Proofs for LLM Inference)](categories/04-zero-knowledge-proof-systems.md#zkgpt-non-interactive-zk-proofs-for-llm-inference)
...
- [zkPyTorch (Hierarchical Compiler for zkML)](categories/04-zero-knowledge-proof-systems.md#zkpytorch-hierarchical-compiler-for-zkml)
- [zkRNN (ZK Proofs for Recurrent Neural Network Inference)](categories/04-zero-knowledge-proof-systems.md#zkrnn-zk-proofs-for-recurrent-neural-network-inference)
