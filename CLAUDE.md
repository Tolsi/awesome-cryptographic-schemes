...
| 22 | attacks-cryptanalysis | EC/DLog (Pohlig-Hellman, Pollard rho/lambda, MOV, Xedni, Index Calculus, Smart, Weil/GHS); symmetric (differential, linear, ARX-linear, boomerang/rectangle, slide, related-key, integral/Square, MITM/biclique, algebraic XL/XSL, cube/higher-order DC); stream (FMS/NOMORE, LFSR correlation, TMTO/Hellman-BSW); hash (Wang MD5/SHA-1, length-extension, Joux multi-collision, Kelsey-Kohno herding, rebound); factoring/RSA (GNFS/QS, p-1/p+1/ECM, Wiener/Boneh-Durfee/Coppersmith, ROCA); lattice (LLL/BKZ, HNP/ECDSA nonce bias, Minerva/TPM-FAIL/LadderLeak); quantum (Shor, Grover, Simon, Kuperberg); protocol-level (Bleichenbacher/ROBOT, DROWN, padding oracle/BEAST/POODLE/Lucky 13, CRIME/BREACH/HEIST, Sweet32, FREAK/Logjam, GCM nonce reuse, 3SHAKE/SLOTH/Selfie/Raccoon); side-channel (SPA/DPA/CPA/template, Flush+Reload/Prime+Probe, Spectre/Meltdown/MDS/Hertzbleed/GoFetch, Bellcore/Rowhammer/PlunderVolt/laser FI, cold boot) |
